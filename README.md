...
One problem I experienced while using my favorite editor instead, was having to exit the serial  
monitor to free the serial port, before code can be uploaded is super annoying.  
